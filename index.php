			...
			<div id="page" class="container">
				<div id="content">
					...
					<div>
						<ul class="style1">
							<li class="first">
								<h3><em><img src="images/img01.jpg" alt="" width="130" height="130" class="alignleft border" /></em>Revisar resultados electorales</h3>
								<p>Pulse aquí para presentar los resultados de las elecciones Municipales, clasificadas por municipio, centro, mesa, candidato o partido.</p>
								<p><a href="menu.php?tipo=resultados" class="button-style">Resultados</a></p>
							</li>
							<li>
								<h3><em><img src="images/img02.jpg" alt="" width="130" height="130" class="alignleft border" /></em>Datos de Votante</h3>
								<p>Pulse aquí para verificar sus datos como votante en el Registro Electoral Permanente (REP) del Consejo Nacional Electoral</p>
								<p><a href="buscarVotante.php" class="button-style">Consulta de Votante</a></p>
							</li>
						</ul>
					</div>
				</div>
